...
package_name = 'webots_proj3'

data_files = []
data_files.append(('share/ament_index/resource_index/packages', ['resource/' + package_name]))
data_files.append(('share/' + package_name + '/launch', ['launch/webots_proj3.launch.py']))

data_files.append(('share/' + package_name + '/worlds', [
    'worlds/maze1_smallest.wbt', 'worlds/maze.wbt' 
]))
...
setup(
    ...
    entry_points={
        ...
        'console_scripts': [
            'webots_proj3 = webots_proj3.webots_proj3:main',
        ],
    },
