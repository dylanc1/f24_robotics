...
def generate_launch_description():
    package_dir = get_package_share_directory('webots_proj3')
    ...
    rviz_config_dir = os.path.join(get_package_share_directory('webots_proj3'),
    ...
    return LaunchDescription([
        ...
        Node(
            package='webots_proj3',
            executable='webots_proj3',
            name='webots_proj3',
            output='screen'
        ),
    ])
